...
func (x *DemotePeerRequest) Reset() {
	*x = DemotePeerRequest{}
...
func (x *DemotePeerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DemotePeerRequest) ProtoMessage() {}

func (x *DemotePeerRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_message_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DemotePeerRequest.ProtoReflect.Descriptor instead.
func (*DemotePeerRequest) Descriptor() ([]byte, []int) {
	return file_api_message_proto_rawDescGZIP(), []int{4}
}

func (x *DemotePeerRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
type DemotePeerResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Leader        string                 `protobuf:"bytes,1,opt,name=leader,proto3" json:"leader,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *DemotePeerResponse) Reset() {
	*x = DemotePeerResponse{}
	mi := &file_api_message_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DemotePeerResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DemotePeerResponse) ProtoMessage() {}

func (x *DemotePeerResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_message_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DemotePeerResponse.ProtoReflect.Descriptor instead.
func (*DemotePeerResponse) Descriptor() ([]byte, []int) {
	return file_api_message_proto_rawDescGZIP(), []int{5}
}

func (x *DemotePeerResponse) GetLeader() string {
	if x != nil {
		return x.Leader
	}
	return ""
...
const file_api_message_proto_rawDesc = "" +
	...
	"\x06leader\x18\x01 \x01(\tR\x06leader\"#\n" +
	"\x11DemotePeerRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\",\n" +
	"\x12DemotePeerResponse\x12\x16\n" +
	"\x06leader\x18\x01 \x01(\tR\x06leader\"=\n" +
	...
	"\x05alias\x18\x01 \x01(\tR\x05alias2\xfa\x04\n" +
	...
	"\n" +
	"NotifyPeer\x12,.weaviate.internal.cluster.NotifyPeerRequest\x1a-.weaviate.internal.cluster.NotifyPeerResponse\"\x00\x12k\n" +
	"\n" +
	"DemotePeer\x12,.weaviate.internal.cluster.DemotePeerRequest\x1a-.weaviate.internal.cluster.DemotePeerResponse\"\x00\x12\\\n" +
...
var file_api_message_proto_goTypes = []any{
	...
	(*DemotePeerRequest)(nil),                          // 8: weaviate.internal.cluster.DemotePeerRequest
	(*DemotePeerResponse)(nil),                         // 9: weaviate.internal.cluster.DemotePeerResponse
	...
	(*SyncShardRequest)(nil),                           // 26: weaviate.internal.cluster.SyncShardRequest
	(*CreateAliasRequest)(nil),                         // 27: weaviate.internal.cluster.CreateAliasRequest
	(*ReplaceAliasRequest)(nil),                        // 28: weaviate.internal.cluster.ReplaceAliasRequest
	(*DeleteAliasRequest)(nil),                         // 29: weaviate.internal.cluster.DeleteAliasRequest
}
var file_api_message_proto_depIdxs = []int32{
	...
	10, // 10: weaviate.internal.cluster.ClusterService.NotifyPeer:input_type -> weaviate.internal.cluster.NotifyPeerRequest
	8,  // 11: weaviate.internal.cluster.ClusterService.DemotePeer:input_type -> weaviate.internal.cluster.DemotePeerRequest
	...
	11, // 16: weaviate.internal.cluster.ClusterService.NotifyPeer:output_type -> weaviate.internal.cluster.NotifyPeerResponse
	9,  // 17: weaviate.internal.cluster.ClusterService.DemotePeer:output_type -> weaviate.internal.cluster.DemotePeerResponse
